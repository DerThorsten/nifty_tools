...
cmake  \
    ...
    \
    -DCMAKE_CXX_LINK_FLAGS="${NIFTY_INFUSION_LDFLAGS}" \
    -DCMAKE_EXE_LINKER_FLAGS="${NIFTY_INFUSION_LDFLAGS}" \
    -DCMAKE_CXX_FLAGS="${NIFTY_INFUSION_CXX_FLAGS}" \
    -DCMAKE_CXX_FLAGS_RELEASE="${NIFTY_INFUSION_CXX_FLAGS_RELEASE}" \
